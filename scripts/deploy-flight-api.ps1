# deploy-flight-api.ps1
# Builds and pushes the Flight Agent API Docker image to ACR,
# configures the Web App container, and sets all required app settings
# including querying the Foundry endpoint for the latest agent version.
